    ...
    public Integer call() {
      ...
      try {
        ...
        if (division.get().hasTeam(teamName)) {
          System.err.printf(
              "Error: Team \"%s\" already exists in division \"%s\".%n",
        ...
        System.out.printf(
            "Team \"%s\" added to division \"%s\".%n", teamName, division.get().name());
        return 0;
      } catch (IOException e) {
  ...
  static class EditCmd implements Callable<Integer> {
    ...
    public Integer call() {
      ...
      try {
        ...
        if (team.isEmpty()) {
          System.err.printf(
              "Error: Team \"%s\" not found in division \"%s\".%n",
              teamName, division.get().name());
          return 1;
        }
        ...
        parent.app.store.save(league.withDivisionReplaced(division.get().id(), updatedDivision));
        System.out.printf(
            "Team \"%s\" renamed to \"%s\" in division \"%s\".%n",
  ...
  static class DeleteCmd implements Callable<Integer> {
    ...
    public Integer call() {
      try {
        ...
        parent.app.store.save(league.withDivisionReplaced(division.get().id(), updatedDivision));
        System.out.printf(
            "Team \"%s\" removed from division \"%s\".%n",
