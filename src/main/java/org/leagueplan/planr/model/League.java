...
public record League(
    ...
    public static League empty() {
        return new League(CURRENT_VERSION, LeagueConfig.empty(), List.of(), List.of(),
    ...
    public League withDivisionAdded(Division division) {
        return new League(version, config,
            ...
            fields, teamSchedule, schedule, playoffs, practiceSchedules);
    }
    ...
    public League withFieldAdded(Field field) {
        return new League(version, config, divisions,
            ...
            teamSchedule, schedule, playoffs, practiceSchedules);
    }
    ...
    public Optional<PracticeSchedule> findPracticeSchedule(UUID divisionId) {
        return practiceSchedules.stream()
            .filter(ps -> ps.divisionId().equals(divisionId))
            .findFirst();
    }
    ...
    public League withPracticeScheduleAdded(PracticeSchedule practiceSchedule) {
        return new League(version, config, divisions, fields, teamSchedule, schedule, playoffs,
