...
public record Field(
    ...
    public Field withBlockAdded(FieldBlock block) {
        return new Field(id, name, address,
            Stream.concat(blocks.stream(), Stream.of(block)).toList(), dateOverrides, divisionLocks);
    }
    ...
    public Field withOverrideAdded(FieldDateOverride override) {
        return new Field(id, name, address, blocks,
            Stream.concat(dateOverrides.stream(), Stream.of(override)).toList(), divisionLocks);
    }
    ...
    public Field withLockAdded(FieldDivisionLock lock) {
        return new Field(id, name, address, blocks, dateOverrides,
