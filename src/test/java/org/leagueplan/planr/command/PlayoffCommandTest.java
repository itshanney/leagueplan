 ...
 *
 * <p>Excludes `playoff assign` (requires the CP-SAT solver and stdin interaction; covered
 * separately in manual/integration testing). All tests use 2-4 teams to keep bracket generation
 * fast.
 *
 * <p>Test data: Division "Majors" with 2 teams: Blue Jays, Cardinals Division "Minors" with 3
 * teams: Red Sox, Yankees, Cubs Division "AAA" with 4 teams: Dodgers, Mets, Braves, Phillies
 */
class PlayoffCommandTest extends CommandTestBase {
  ...
  private int generatePlayoff(String division, String start, String end, String... seeds) {
    ...
    args.addAll(
        List.of("playoff", "generate", "--division", division, "--start", start, "--end", end));
  ...
  class Generate {
    ...
    void successTwoTeams() {
      ...
      int exit = generatePlayoff("Majors", "2026-06-14", "2026-06-28", "Blue Jays", "Cardinals");
      assertEquals(0, exit);
    ...
    void successFourTeams() {
      ...
      int exit =
          generatePlayoff(
              "AAA", "2026-06-14", "2026-06-28", "Dodgers", "Mets", "Braves", "Phillies");
      assertEquals(0, exit);
    ...
    void failsWhenDivisionNotFound() {
      int exit = generatePlayoff("NonExistent", "2026-06-14", "2026-06-28", "TeamA", "TeamB");
      assertEquals(1, exit);
    ...
    void failsWhenEndBeforeStart() {
      addDivisionWithTeams("Majors", 60, "Blue Jays", "Cardinals");
      int exit = generatePlayoff("Majors", "2026-06-28", "2026-06-14", "Blue Jays", "Cardinals");
      assertEquals(1, exit);
    ...
    void failsOnInvalidStartDate() {
      addDivisionWithTeams("Majors", 60, "Blue Jays", "Cardinals");
      int exit = generatePlayoff("Majors", "not-a-date", "2026-06-28", "Blue Jays", "Cardinals");
      assertEquals(1, exit);
    ...
    void failsWhenSeedCountMismatch() {
      ...
      int exit =
          generatePlayoff("Majors", "2026-06-14", "2026-06-28", "Blue Jays", "Cardinals", "Tigers");
      assertEquals(1, exit);
    ...
    void failsOnDuplicateSeeds() {
      addDivisionWithTeams("Majors", 60, "Blue Jays", "Cardinals");
      int exit = generatePlayoff("Majors", "2026-06-14", "2026-06-28", "Blue Jays", "Blue Jays");
      assertEquals(1, exit);
    ...
    void failsWhenPlayoffAlreadyExists() {
      addDivisionWithTeams("Majors", 60, "Blue Jays", "Cardinals");
      generatePlayoff("Majors", "2026-06-14", "2026-06-28", "Blue Jays", "Cardinals");
      int exit = generatePlayoff("Majors", "2026-07-01", "2026-07-14", "Blue Jays", "Cardinals");
      assertEquals(1, exit);
    ...
    void ioErrorReturns2() throws Exception {
      corruptLeagueFile();
      int exit = generatePlayoff("Majors", "2026-06-14", "2026-06-28", "TeamA", "TeamB");
      assertEquals(2, exit);
    }
  }
