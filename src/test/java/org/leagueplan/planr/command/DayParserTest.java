...
class DayParserTest {
  ...
  class ParseFullNames {
    ...
    void tuesday() {
      assertEquals(DayOfWeek.TUESDAY, DayParser.parse("tuesday").orElseThrow());
    }
    ...
    void thursday() {
      assertEquals(DayOfWeek.THURSDAY, DayParser.parse("thursday").orElseThrow());
    }
    ...
    void saturday() {
      assertEquals(DayOfWeek.SATURDAY, DayParser.parse("saturday").orElseThrow());
    }

    @Test
    @DisplayName("parses sunday")
    void sunday() {
      assertEquals(DayOfWeek.SUNDAY, DayParser.parse("sunday").orElseThrow());
    }
  }
  ...
  class ParseAbbreviations {
    ...
    void tue() {
      assertEquals(DayOfWeek.TUESDAY, DayParser.parse("tue").orElseThrow());
    }

    @Test
    @DisplayName("parses wed")
    void wed() {
      assertEquals(DayOfWeek.WEDNESDAY, DayParser.parse("wed").orElseThrow());
    }

    @Test
    @DisplayName("parses thu")
    void thu() {
      assertEquals(DayOfWeek.THURSDAY, DayParser.parse("thu").orElseThrow());
    }

    @Test
    @DisplayName("parses fri")
    void fri() {
      assertEquals(DayOfWeek.FRIDAY, DayParser.parse("fri").orElseThrow());
    }

    @Test
    @DisplayName("parses sat")
    void sat() {
      assertEquals(DayOfWeek.SATURDAY, DayParser.parse("sat").orElseThrow());
    }
  ...
  void hintIsDescriptive() {
    ...
    assertTrue(
        hint.contains("monday") || hint.contains("mon"),
  ...
  class DisplayNameTests {
    ...
    void monday() {
      assertEquals("Monday", DayParser.displayName(DayOfWeek.MONDAY));
    }

    @Test
    @DisplayName("returns title-case Wednesday for WEDNESDAY")
    void wednesday() {
      assertEquals("Wednesday", DayParser.displayName(DayOfWeek.WEDNESDAY));
    }

    @Test
    @DisplayName("returns title-case Sunday for SUNDAY")
    void sunday() {
      assertEquals("Sunday", DayParser.displayName(DayOfWeek.SUNDAY));
    }
